"""Structured logging configuration for orphanet-link.
...
def _add_static_fields(_logger: Any, _name: str, event_dict: dict[str, Any]) -> dict[str, Any]:
    ...
    event_dict.setdefault("service", "orphanet-link")
...
def configure_logging() -> FilteringBoundLogger:
    ...
    configure_structlog()
    return structlog.get_logger("orphanet_link")  # type: ignore[no-any-return]
